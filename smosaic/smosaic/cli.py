...
@click.option('--mosaic-method',
              type=click.Choice(
                  ['lcf', 'chrono', 'ctd', 'avg', 'media', 'med', 'mediana', 'max', 'min', 'maxx', 'minx'],
...
@click.option('--k',
              ...
              default=1,
              show_default=True,
              help='Rank for maxx/minx methods (1 = absolute extreme)')
@click.option('--banda-ref',
              default=None,
              help='Reference band for maxx/minx methods (e.g. B12 or NBR)')
@pass_config
def mosaic(
    config: Config,
    verbose,
